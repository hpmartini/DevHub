 ...
 *
 * This component contains ALL dashboard logic, completely separated from landing page.
 * It should only import dashboard-related components and shared utilities.
 */
  ...
  useEffect(() => {
    ...
    if (projectId) {
      ...
      if (projectExists) {
        ...
        // Invalid/stale project ID - redirect to root (dashboard)
