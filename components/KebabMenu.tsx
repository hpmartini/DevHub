  ...
  return (
    <div className="relative" ref={menuRef}>
      <button
        ...
        className={`rounded hover:bg-gray-700 text-gray-400 hover:text-white transition-colors ${
          size === 'sm' ? 'p-1' : 'p-1.5'
        }`}
      ...
      {isOpen && (
        <div
          className={`absolute z-50 mt-1 py-1 bg-gray-800 border border-gray-700 rounded-lg shadow-xl min-w-[180px] animate-in fade-in zoom-in-95 duration-150 ${
